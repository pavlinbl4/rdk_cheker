...
def check_article_status(article_name, article_status, today_filename, pickle_folder):
    ...
    try:
        ic(article_dict[article_name], article_status)
        # ic(article_dict[article_name] != article_status and article_status == '***&site')
        # ic(article_status == '***&site')
        # ic(article_dict[article_name] != article_status)
...
if __name__ == '__main__':
    ...
    check_article_status('Юлию Харитону 120 лет', '***&site', '27-02-2024', 'Pickle_files')
